...
with engine.begin() as conn:
    ...
    df_digital = df_digital[["UsageDate","UserType","ResourceType","Faculty","DownloadCount","Duration_Minutes"]]
    ...
    # --- FACT: BOOK TRANSACTIONS ---
    conn.execute(text("""
        INSERT INTO fact_library_usage
        (date_key, student_key, book_key, faculty_key, room_key, downloads, duration_minutes, booking_hours)
        SELECT
            dd.date_key,
            ds.student_key,
            db.book_key,
...
logging.info(" ELT Pipeline Completed Successfully with Star Schema Mapping!")
